...
function Comprension() {
  ...
  function changeStimuli(punt){
    if((badAnswerCount < LIMIT_ERROR && numberItem < NUMBER_STIMULI)){ // Verifica que no se haya cumplido la condicion de termino
      ...
      case "test":
        ...
        <div > 
          ...
          <div id="generalC">
            ...
            <Typography variant="body2" component="p"> {general[numberItem]} </Typography>
          </div>
          <br/>
          ...
          {/*<Grid container justify="center" spacing={2}>
            <Grid item xs={1}> <Typography gutterBottom variant="h5" component="h2"> 0 puntos </Typography> </Grid>
            <Grid item xs={1}> <Typography gutterBottom variant="h5" component="h2"> 1 punto </Typography> </Grid>
            <Grid item xs={1}> <Typography gutterBottom variant="h5" component="h2"> 2 puntos </Typography> </Grid>
          </Grid>
          ...
          <Grid container justify="center" spacing={2}>
            <Grid item xs={1}> <p>{comentary[numberItem]}</p> </Grid>
          </Grid>
          ...
          {/*<div className={classes.fields}>
            <div >
              <h2><b>0 Puntos</b></h2>
              <br/>
            <TextareaAutosize value={badAnswer[numberItem]} disabled></TextareaAutosize>
            </div>
            &nbsp;  &nbsp; &nbsp;  &nbsp;
            <div >
              <h2><b>1 Punto</b></h2>
              <br/>
              <TextareaAutosize value={mediumAnswer[numberItem]} disabled></TextareaAutosize>
            </div>
            &nbsp;  &nbsp; &nbsp;  &nbsp;
            <div >
              <h2><b>2 Puntos</b></h2>
              <br/>
              <TextareaAutosize value={rightAnswer[numberItem]} disabled></TextareaAutosize>
            </div>
          </div>    
          <br/><br/>

          <div className={classes.ordenar}>
            <p>{comentary[numberItem]}</p>
          </div>
