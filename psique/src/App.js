...
function App(props) {
  ...
  return (
    ...
    <Router>
      ...
      <Route exact path="/test/wisc" component={()=><Sidenav body={"WISC IV"} subtest={"aplicacion"}></Sidenav>} />
      ...
      <Route exact path="/test/wais" component={()=><Sidenav body={"WAIS IV"} subtest={"aplicacion"}></Sidenav>} />
