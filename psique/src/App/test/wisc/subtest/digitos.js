    ...
    switch (state) {
      case 'instruccion':
        ...
        <div>
         ...
         <p>Se realizarán dos puebas, el profesional deberá dictar una lista de números al paciente</p>
         <p>La tarea del paciente es repetir (1ra prueba) y repetir en orden inverso (2da prueba)</p>
